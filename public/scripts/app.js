...
//                'angularSoap'
            ...
            .config(function ($stateProvider, $urlRouterProvider, $authProvider, $httpProvider, $provide) {
                ...
                $authProvider.loginUrl = 'laravel2/public/api/authenticate';
                ...
                $stateProvider
                        ...
                        .state('speakers', {
                            url: '/speakers',
                            templateUrl: '../public/views/speakers/browse.html',
                            controller: 'speakerController as speaker'
                        })
                        .state('speakers/edit/:id', {
                            url: '/speakers/edit/:id',
                            templateUrl: '../public/views/speakers/edit.html',
                            controller: 'editSpeakerController as speaker'
                        })
                        .state('speakers/new', {
                            url: '/speakers/new',
                            templateUrl: '../public/views/speakers/create.html',
                            controller: 'createSpeakerController as speaker'
                        });
